...
public class DbInitializer
{
    ...
    private static void SeedPosts(ClothingShopDbContext context)
    {
        if (!context.Posts.Any())
        {
            ...
            {
                new Post { Id = 1, Title = "Men's Spring Collection", Content = "Latest trends in men's fashion for spring.", Slogan = "Refresh Your Style", Slug = "mens-spring-collection", ImgSrc = "img/posts/post1.jpg", ImgAlt = "Men Spring Collection", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-30), Published = DateTime.UtcNow.AddDays(-28) },
                new Post { Id = 2, Title = "Top Women's Dresses", Content = "Explore the most popular dresses this season.", Slogan = "Elegance Redefined", Slug = "top-womens-dresses", ImgSrc = "img/posts/post2.jpg", ImgAlt = "Women's Dresses", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-29), Published = DateTime.UtcNow.AddDays(-27) },
                new Post { Id = 3, Title = "Accessory Trends 2026", Content = "Belts, watches, hats – what's in fashion now.", Slogan = "Accessorize Your Life", Slug = "accessory-trends-2026", ImgSrc = "img/posts/post3.jpg", ImgAlt = "Accessories", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-25), Published = DateTime.UtcNow.AddDays(-23) },
                new Post { Id = 4, Title = "Sneakers Must-Have", Content = "Casual and stylish sneakers for all occasions.", Slogan = "Step Up Your Game", Slug = "sneakers-must-have", ImgSrc = "img/posts/post4.jpg", ImgAlt = "Sneakers", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-22), Published = DateTime.UtcNow.AddDays(-20) },
                new Post { Id = 5, Title = "Luxury Streetwear Guide", Content = "How to combine streetwear and luxury pieces.", Slogan = "Luxury Meets Street", Slug = "luxury-streetwear-guide", ImgSrc = "img/posts/post5.jpg", ImgAlt = "Streetwear", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-20), Published = DateTime.UtcNow.AddDays(-18) },
                new Post { Id = 6, Title = "Summer Sale Highlights", Content = "Best deals on summer clothing.", Slogan = "Hot Deals for Hot Days", Slug = "summer-sale-highlights", ImgSrc = "img/posts/post6.jpg", ImgAlt = "Summer Sale", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-18), Published = DateTime.UtcNow.AddDays(-16) },
                new Post { Id = 7, Title = "Men's Jackets Collection", Content = "Stay warm with style this winter.", Slogan = "Cozy & Cool", Slug = "mens-jackets-collection", ImgSrc = "img/posts/post7.jpg", ImgAlt = "Men Jackets", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-15), Published = DateTime.UtcNow.AddDays(-14) },
                new Post { Id = 8, Title = "Women's Skirt Trends", Content = "Skirts that define this year's fashion.", Slogan = "Twirl in Style", Slug = "womens-skirt-trends", ImgSrc = "img/posts/post8.jpg", ImgAlt = "Women Skirts", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-13), Published = DateTime.UtcNow.AddDays(-12) },
                new Post { Id = 9, Title = "Boots You Need", Content = "Leather and casual boots for every outfit.", Slogan = "Step in Style", Slug = "boots-you-need", ImgSrc = "img/posts/post9.jpg", ImgAlt = "Boots", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-11), Published = DateTime.UtcNow.AddDays(-10) },
                new Post { Id = 10, Title = "Men Sale Picks", Content = "Top discounted items for men.", Slogan = "Save & Style", Slug = "men-sale-picks", ImgSrc = "img/posts/post10.jpg", ImgAlt = "Men Sale", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-9), Published = DateTime.UtcNow.AddDays(-8) },
                new Post { Id = 11, Title = "Women Sale Picks", Content = "Top discounted items for women.", Slogan = "Stylish Savings", Slug = "women-sale-picks", ImgSrc = "img/posts/post11.jpg", ImgAlt = "Women Sale", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-7), Published = DateTime.UtcNow.AddDays(-6) },
                new Post { Id = 12, Title = "Spring Fashion Essentials", Content = "Must-have items for spring.", Slogan = "Fresh Looks", Slug = "spring-fashion-essentials", ImgSrc = "img/posts/post12.jpg", ImgAlt = "Spring Fashion", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-6), Published = DateTime.UtcNow.AddDays(-5) },
                new Post { Id = 13, Title = "Autumn Streetwear", Content = "Urban fashion for cooler months.", Slogan = "Fall in Style", Slug = "autumn-streetwear", ImgSrc = "img/posts/post13.jpg", ImgAlt = "Streetwear", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-5), Published = DateTime.UtcNow.AddDays(-4) },
                new Post { Id = 14, Title = "Winter Coats Guide", Content = "Warm and stylish coats.", Slogan = "Bundle Up Fashionably", Slug = "winter-coats-guide", ImgSrc = "img/posts/post14.jpg", ImgAlt = "Winter Coats", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-4), Published = DateTime.UtcNow.AddDays(-3) },
                new Post { Id = 15, Title = "Luxury Accessories", Content = "Exclusive watches and belts.", Slogan = "Accessorize Luxuriously", Slug = "luxury-accessories", ImgSrc = "img/posts/post15.jpg", ImgAlt = "Luxury Accessories", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-3), Published = DateTime.UtcNow.AddDays(-2) },
                new Post { Id = 16, Title = "Trending T-Shirts", Content = "Casual T-Shirts everyone loves.", Slogan = "Cool & Casual", Slug = "trending-tshirts", ImgSrc = "img/posts/post16.jpg", ImgAlt = "T-Shirts", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-2), Published = DateTime.UtcNow.AddDays(-1) },
                new Post { Id = 17, Title = "Minimalist Fashion", Content = "Clean, simple, and stylish looks.", Slogan = "Less is More", Slug = "minimalist-fashion", ImgSrc = "img/posts/post17.jpg", ImgAlt = "Minimal Fashion", Status = PostStatuses.Published, Created = DateTime.UtcNow.AddDays(-1), Published = DateTime.UtcNow },
                new Post { Id = 18, Title = "New Collection Launch", Content = "Check out our latest collection.", Slogan = "Be First, Be Stylish", Slug = "new-collection-launch", ImgSrc = "img/posts/post18.jpg", ImgAlt = "New Collection", Status = PostStatuses.Published, Created = DateTime.UtcNow, Published = DateTime.UtcNow },
                new Post { Id = 19, Title = "Streetwear Must-Haves", Content = "Complete your urban look.", Slogan = "Urban Essentials", Slug = "streetwear-must-haves", ImgSrc = "img/posts/post19.jpg", ImgAlt = "Streetwear", Status = PostStatuses.Published },
                new Post { Id = 20, Title = "Luxury Jackets", Content = "Premium jackets for elite style.", Slogan = "Exclusive & Elegant", Slug = "luxury-jackets", ImgSrc = "img/posts/post20.jpg", ImgAlt = "Luxury Jackets", Status = PostStatuses.Published },
                new Post { Id = 21, Title = "Fashion Tips for Men", Content = "Styling advice for men’s fashion.", Slogan = "Look Sharp", Slug = "fashion-tips-men", ImgSrc = "img/posts/post21.jpg", ImgAlt = "Fashion Tips", Status = PostStatuses.Published }
            };
